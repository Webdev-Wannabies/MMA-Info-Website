<?php
	...
	else
	{
		...
		{
			header('Location: ../panel.php?type=fights&fighter_id=' . $fighter_id . '&opponent_id=' . $opponent_id . '&weightclass_id=' . $weightclass_id . '&event_id=' . $event_id .'&result_type_id=' . $result_type_id .
