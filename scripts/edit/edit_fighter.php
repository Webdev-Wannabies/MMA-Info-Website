<?php
	...
	else
	{
		...
		{
			header('Location: ../panel.php?type=fighters&id='.$id.'&first_name='.$first_name.'&last_name='.$last_name.'&nickname='.$nickname.'&gender='.$gender.'&birthdate='.$birthdate.'&height='.$height.'&weight='.$weight.'&country_id='.$country_id.'&association_id='.$association_id);
			exit();
		}
	}
